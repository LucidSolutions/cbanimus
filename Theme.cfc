...
component{
    ...
    { name="siteFooterName", 		group="Footer", defaultValue="Lucid OutSourcing Solutions", 		type="text", 	label="Site Name"},
    { name="siteFooterURL", 		group="Footer", defaultValue="http://www.lucidsolutions.in", 		type="text", 	label="Site URL"},
    ...
    { name="showEntriesURLFB", 	group="Social Group", defaultValue="", type="text",	label="URL for Facebook", 	required="false" },
    { name="showEntriesURLTWT", 	group="Social Group", defaultValue="", type="text",	label="URL for Twitter", 	required="false" }
	];
